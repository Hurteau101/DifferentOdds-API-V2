class MarketHander:
    ...
    def price_to_odds(price):
        ...
        if price >= 0.5:
            american_odds = round(-(price / (1 - price)) * 100)
        else:
            american_odds = round(((1 - price) / price) * 100)

        fractional_odds = round((1 - price) / price, 2)
        ...
        return [
            {
                **base,
                ...
                "odds": MarketHander.price_to_odds(self.market_object.get(f"{option}_ask") / 100),
            }
