...
class Buckeye2(PPHBookBase):
    ...
    def total_type(self, game_data: dict, market_name: str, **kwargs) -> list:
        ...
        for bet_type, line_key, odds_key in [("Over", over_points_line_name, over_points_odds_name), ("Under", under_points_line_name, under_points_odds_name)]:
            override_market_name = kwargs.get("override_market_name", False)
            mapped_market_name = self.name_mapper(market_name=market_name, odds_key=odds_key, base_market_mapper={}, **kwargs) if not override_market_name else market_name
            ...
            odds.append(SportsbookStats(
                ...
                bet_player=kwargs.get("bet_player", None)
            ))
    ...
    async def build_player_markets(self, event_data: dict):
        ...
        player_name = event_data.get("Team1ID")
        raw_market_name = event_data.get("Team2ID")
